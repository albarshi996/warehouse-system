...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      // ‹LPN-206› حوكمة الطبالي: القرار بين «قرأتُ» و«صار مخزونًا».
      // للمديرَين وحدهما اليوم — وأمينُ المخزن يكوّن الطبلية ولا يعتمدها
      // (فصلُ المهامّ: من يعدّ لا يُصدّق على عدّه).
      // ★ ومفتّشُ الجودة صاحبُها الطبيعيّ، لكنّه لا يرى مجموعة «المستودعات»
      // أصلًا — ومنحُه المجموعة كاملةً لأجل شاشةٍ واحدة توسيعٌ صامت لصلاحيته.
      // فيُؤجَّل إلى ‹LPN-506› حيث تُبنى الأدوار المخزنيّة الثمانية بمصفوفةٍ
      // مختبَرة (دور × وضع) — لا بترقيعٍ هنا.
      { path: '/dashboard/lpn-governance', label: 'حوكمة الطبالي', icon: 'package', roles: ['admin', 'warehouse_manager'] },
      // ‹LPN-212› الاستلام الميدانيّ: من أمرٍ مفتوح إلى طبليةٍ تُرفع للحوكمة.
      // لأمين المخزن كما للمديرَين — وهو أوّل من يقف عند الشاحنة. ولا يعتمد
      // ما كوّنه (فصلُ المهامّ)، فالحوكمة محصورةٌ بالمديرَين أعلاه.
