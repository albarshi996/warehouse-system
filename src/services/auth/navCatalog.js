...
export const NAV_GROUPS = [
  ...
  },
  {
    ...
    items: [
      ...
      // «الهوية التشغيلية للمستودعات»: عرض الجلسة المشتركة مع إدارة التسويق —
      // محورها تقريرها البصريّ، ودعواها أنّ ترميز المواقع قائمٌ في النظام
      // فاللوحة تطبعه ولا تخترعه. تُفتح أمام التسويق في الجلسة نفسها.
