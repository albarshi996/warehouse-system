...
export const ROLE_NAV = {
  ...
  gate_officer: ['daily', 'odoo', 'fleet', 'putaway', 'lpn'],
  ...
  // ‹LPN-720› والعادّ يدخل «التنفيذ الميدانيّ» لقراءة **سجلّ الباركود**
  // وحده — تدقيقٌ لا تشغيل، وأدواتُ البنية تختفي عمّن لا يملكها.
