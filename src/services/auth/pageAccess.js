...
export const ALWAYS_ALLOWED = [
  ...
  // مرحلة اعتماد نظام تصميم أودو (مرحلة ٠) — صفحتان جديدتان معزولتان في حاوية
  // .o_theme الفاتحة: مرجع الأنماط والشاشة التجريبية. تُدرَجان في القائمة
  // رسميًّا عند اعتماد التعميم (طلب منفصل)؛ حتى ذلك يكفي الاستثناء الصريح كي
