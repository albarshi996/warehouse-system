...
@media print {
  ...
  * { -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
  ...
  .ph-logo { width: 40px; height: 40px; background: linear-gradient(135deg, #8B0000, #C0392B) !important; border-radius: 10px; display: flex; align-items: center; justify-content: center; color: #fff !important; font-weight: 800; font-size: 13px; letter-spacing: -1px; }
