    ...
    return (
      <svg viewBox={`0 0 ${W} ${H}`} width="100%" style={{ maxHeight: '420px', background: '#fafbff', borderRadius: '12px', display: 'block' }}>
        ...
        <g transform={`translate(${W / 2}, ${H - mg + 35})`}>
          <rect x="-60" y="-5" width="120" height="12" fill="#c41e3a" rx="2" />
          <path d="M 0 7 L 0 25" stroke="#c41e3a" strokeWidth="3" markerEnd="url(#arrowhead)" />
          <text x="0" y="45" textAnchor="middle" fontSize="14" fill="#c41e3a" fontWeight="bold" fontFamily="Cairo,sans-serif">بوابة الدخول الرئيسية | MAIN LOADING BAY</text>
        </g>
              ...
              rows.push(
                <tr key={`${u.id}-${aisle}-${b}-${lv}`}>
                  <td style={{ padding: '8px 10px', borderBottom: '1px solid #dde3ec' }}>
                    ...
                    <span className="addr-code" style={{ fontFamily: 'monospace', background: '#1a2b4c', color: '#DAAA3C', padding: '2px 8px', borderRadius: '4px', fontSize: '12px' }}>
                      {code}
                    </span>
                  </td>
  ...
  return (
    <div className="container" style={{ maxWidth: '1500px', margin: 'auto', padding: '20px', fontFamily: 'Cairo, sans-serif', position: 'relative' }}>
      ...
      <style>{`
        ...
        .fill-bar { position: absolute; bottom: 0; left: 0; height: 4px; background: #DAAA3C; transition: width 0.3s; }
      ...
      <div className="header" style={{ background: 'linear-gradient(135deg, #1a2b4c 0%, #243b6e 100%)', color: 'white', borderRadius: '14px', padding: '24px 30px', marginBottom: '20px', display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: '12px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', flexWrap: 'wrap', alignItems: 'center' }}>
          <span className="badge" style={{ background: '#DAAA3C', color: '#1a2b4c', fontWeight: 700, padding: '4px 14px', borderRadius: '20px', fontSize: '12px' }}>19 وحدة تبريد</span>
          <span className="badge" style={{ background: '#DAAA3C', color: '#1a2b4c', fontWeight: 700, padding: '4px 14px', borderRadius: '20px', fontSize: '12px' }}>63 م² / وحدة</span>
          <button className="btn no-print" style={{ padding: '8px 20px', border: 'none', borderRadius: '8px', cursor: 'pointer', fontFamily: 'Cairo', fontSize: '13px', fontWeight: 600, background: '#c41e3a', color: 'white' }} onClick={() => window.print()}>🖨️ طباعة</button>
        </div>
      </div>
      ...
      <div className="grid-4" style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '14px', marginBottom: '20px' }}>
        {[
          ...
          <div key={i} className="kpi" style={{ background: '#1a2b4c', color: 'white', borderRadius: '10px', padding: '16px', textAlign: 'center' }}>
            <div className="val" style={{ fontSize: '26px', fontWeight: 900, color: '#DAAA3C' }}>{k.val}</div>
      ...
      <div className="grid-2" style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '20px' }}>
        <div className="card" style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 10px rgba(0,0,0,.07)', marginBottom: '20px' }}>
          <div className="card-title" style={{ fontSize: '15px', fontWeight: 700, color: '#1a2b4c', marginBottom: '14px', paddingBottom: '10px', borderBottom: '2px solid #DAAA3C', display: 'flex', alignItems: 'center', gap: '8px' }}>🗺️ شبكة الوحدات ({CFG.totalUnits} ثلاجة)</div>
          ...
          <div style={{ marginTop: '16px' }}>
            <div className="card-title" style={{ fontSize: '13px', fontWeight: 700, color: '#1a2b4c', marginBottom: '14px', paddingBottom: '10px', borderBottom: '2px solid #DAAA3C' }}>📊 توزيع الفئات</div>
            {catSummary}
          </div>
        </div>

        <div className="card" style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 10px rgba(0,0,0,.07)', marginBottom: '20px' }}>
          <div className="card-title" style={{ fontSize: '15px', fontWeight: 700, color: '#1a2b4c', marginBottom: '14px', paddingBottom: '10px', borderBottom: '2px solid #DAAA3C', display: 'flex', alignItems: 'center', gap: '8px' }}>
            ❄️ تفاصيل الوحدة <span style={{ fontFamily: 'monospace', color: '#DAAA3C' }}>{pad(unit.id)}</span> — {unit.name}
          </div>
          ...
          <div style={{ background: '#f4f6f9', borderRadius: '8px', padding: '12px' }}>
            ...
            <div style={{ background: '#dde3ec', borderRadius: '8px', height: '10px', overflow: 'hidden' }}>
              <div style={{ height: '100%', background: '#DAAA3C', width: `${unit.fillPct}%` }}></div>
            </div>
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr 1fr', gap: '8px', marginTop: '12px', textAlign: 'center', fontSize: '12px' }}>
              ...
              <div style={{ background: 'white', borderRadius: '6px', padding: '8px' }}><div style={{ fontWeight: 700, color: '#DAAA3C', fontSize: '16px' }}>{fmt(s.cartonsPerUnit)}</div><div style={{ color: '#7f8c9b' }}>صندوق</div></div>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="card" style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 10px rgba(0,0,0,.07)', marginBottom: '20px' }}>
        <div className="card-title" style={{ fontSize: '15px', fontWeight: 700, color: '#1a2b4c', marginBottom: '14px', paddingBottom: '10px', borderBottom: '2px solid #DAAA3C', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
      ...
      <div className="card" style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 10px rgba(0,0,0,.07)', marginBottom: '20px' }}>
        <div className="card-title" style={{ fontSize: '15px', fontWeight: 700, color: '#1a2b4c', marginBottom: '14px', paddingBottom: '10px', borderBottom: '2px solid #DAAA3C' }}>🔖 نظام العنونة العالمي — Global Location Number (GLN)</div>
          ...
          <div>
            ...
            {[
              ...
              <div key={idx} style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '8px' }}>
                <span style={{ fontFamily: 'monospace', background: '#1a2b4c', color: '#DAAA3C', padding: '2px 8px', borderRadius: '4px', fontSize: '12px' }}>{code}</span>
      ...
      <div className="card" style={{ background: 'white', borderRadius: '12px', padding: '20px', boxShadow: '0 2px 10px rgba(0,0,0,.07)', marginBottom: '20px' }}>
        <div className="card-title" style={{ fontSize: '15px', fontWeight: 700, color: '#1a2b4c', marginBottom: '14px', paddingBottom: '10px', borderBottom: '2px solid #DAAA3C' }}>📘 دليل التخزين الحراري والتوزيع</div>
