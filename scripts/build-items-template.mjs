...
const GUIDE = {
  ...
  minStock: 'حدّ إعادة الطلب. عليه يقوم تنبيه «المخزون المنخفض» في شاشة الأصناف — واتركه فارغًا فلا تنبيه.',
  status: 'نشط (أو اتركه فارغًا) · موقوف = يُخفى من القوائم دون حذف. الفارغ يعني نشطًا.',
  // ── الأرصدة ──
  ...
  unitCost: 'تكلفة الوحدة في **هذه التشغيلة** — لا سعر الشراء الحالي. عليها يقوم تقييم المخزون والإغلاق المالي.',
